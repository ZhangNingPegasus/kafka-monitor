...
<div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:700px">
            <input type="text" name="topicName" lay-verify="required" placeholder="请填写主题名称" autocomplete="off"
                   autofocus="autofocus"
                   class="layui-input">
            <span class="layui-bg-red"><i class="layui-icon layui-icon-about"></i>&nbsp;由字母、数字或下划线组成，区分大小写。例如"Demo_Kafka_Topic_1"</span>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:700px">
            ...
            <span class="layui-bg-red"><i class="layui-icon layui-icon-about"></i>&nbsp;主题的主分片数量，建议是集群数量的整数倍</span>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:700px">
            ...
            <span class="layui-bg-red"><i class="layui-icon layui-icon-about"></i>&nbsp;每个主分片的副本分片数量</span>
        </div>
    </div>
